...
![Рисунок 1 - Розрахунок вихідних даних](./assets/screenshots/01-вихідні-дані.png)

*Рисунок 1 - Розрахунок вихідних даних для варіанта 12.*
...
Перетин півплощин, заданих обмеженнями та умовами невід'ємності, утворює допустимий чотирикутник.

![Рисунок 2 - Область допустимих розв'язків](./assets/screenshots/02-область-допустимих-розв'язків.png)

*Рисунок 2 - Область допустимих розв'язків та її кутові точки.*
...
![Рисунок 3 - Перевірка значень у вершинах](./assets/screenshots/04-перевірка-вершин.png)

*Рисунок 3 - Порівняння значень цільової функції у кутових точках.*

Лінію рівня цільової функції переміщуємо паралельно в напрямі вектора градієнта \(\nabla F=(6;7{,}2)\). Остання спільна точка цієї лінії з допустимою областю - \(P_2\).

![Рисунок 4 - Пошук максимуму цільової функції](./assets/screenshots/03-цільова-функція.png)

*Рисунок 4 - Оптимальна лінія рівня та напрям зростання цільової функції.*
...
Обидва ресурси в оптимальній точці використано повністю, тобто обидва обмеження є активними.

![Рисунок 5 - Результат виконання програми](./assets/screenshots/05-результат-програми.png)

*Рисунок 5 - Підсумок автоматизованого розрахунку.*
